...
let envVariables = {
  ...
  PORTAL_ECHO_API_URL: 'https://www.jaldhara.in/api/echo/',
  ...
  PORTAL_TITLE_NAME: env.sunbird_portal_title_name || 'Jaldhara',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://www.jaldhara.in/api/',
