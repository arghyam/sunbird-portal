    ...
    __createObject() {
        return async((data, reqID) => {
            try {
                ...
                console.log("Announcement - create object - Response", result && result.response)
                return {
    ...
    __findObject() {
            return async((data) => {
                try {
                    ...
                    // console.log("Announcement - find object - Response", result && result.response)
    ...
    __getMetrics() {
        return async((query, reqID) => {
            try {
                ...
                // console.log("Announcement - get metrics - Response", result && result.response)
