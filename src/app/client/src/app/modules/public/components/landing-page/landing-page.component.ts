...
export class LandingPageComponent implements OnInit {
  ...
  getHomepageContent(){
    this.homepageContent = 'Estimates suggest that India will fully utilize its water resources by 2050. The largest consumer of groundwater is agriculture which forms the mainstay of livelihood for almost half the country (49% as of 2011-12) especially in the decades following the green revolution.'
    +'Groundwater contributes 62.4% of water used for irrigation & close to 90% of rural drinking water supply. This dependence on groundwater is only bound to increase as we adopt ambitious irrigation and drinking water supply targets.'
    +'It is thus no surprise that we are the largest abstractors of groundwater in the world – with extraction exceeding the combined withdrawals of USA and China.'
    ...
    this.homepageContentP2 = 'Societal Platforms are one of many ways forward to resolve complex societal challenges. They are imagined as a public good aimed at extending citizen services across our demographics and facilitating meaningful collaboration, amplified by technology.'
